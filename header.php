...
<header id="header">
    <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
        <p class="font-Cairo font-size-12 text-black-50 m-0">Heba Asker (02+) 1020937901</p>
        <div class="font-Cairo font-size-14">
    ...
    <!-- Primary Navigation -->
            <nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav m-auto font-Cairo">
                  ...
                  <form action="#" class="font-size-14 font-Cairo">
